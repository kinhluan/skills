...
# Detailed Slide Automation Guide

> Reference status: Extended examples are tool-specific. Use only the section matching the selected output format and verify the rendered deck.
