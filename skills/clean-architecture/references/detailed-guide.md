...
> Reference status: Extended layouts are examples, not a required folder structure. Apply the dependency rule only at boundaries justified by change and testing needs.
