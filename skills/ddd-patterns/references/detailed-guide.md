...
# Detailed DDD Integration Patterns Guide

> Reference status: Extended examples illustrate patterns, not mandatory architecture. Start with the forces and guardrails in the top-level `SKILL.md`.
