...
- Read [references/concepts.md](references/concepts.md) when C4 terminology or level selection is unclear.
- Use [references/templates.md](references/templates.md) for reusable diagram templates.
- Run [references/validation-checklist.md](references/validation-checklist.md) before handing off a diagram.
