...
1.  Identify the **Primary User** (Person).
2.  Trace their **Happy Path** across the systems (e.g., "Customer buys a product").
3.  Label arrows with **Action Verbs** reflecting the journey (e.g., "Places order using", "Receives invoice from").
